...
public class MemoryDBSnapshotTest extends AbstractReaderTest {
    ...
    public MemoryDBSnapshotTest() throws SQLException, ClassNotFoundException {
        super();

        fields = new Field[3];

        fields[0] = DSL.field(CircuitBreakerValue.estimated.toString(),
                Double.class);
        fields[1] =
                DSL.field(CircuitBreakerValue.limitConfigured.toString(), Double.class);
        fields[2] = DSL.field(CircuitBreakerValue.tripped.toString(),
                Double.class);
    }
    ...
    public void testAlignWindow() throws Exception {
        ...
        Result<Record> res = circuitFinal.fetchMetric(
                getDimensionEqCondition(CircuitBreakerDimension.type,
                        CircuitBreakerType.fielddata.toString()),
                fields);
