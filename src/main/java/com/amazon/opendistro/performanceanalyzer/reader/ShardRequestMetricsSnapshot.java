...
public class ShardRequestMetricsSnapshot implements Removable {
    ...
    public enum Fields {
        shard, indexName, rid, tid, operation, role, st, et, lat, tUtil, ttime, latest
    };
    ...
    public ShardRequestMetricsSnapshot(Connection conn, Long windowStartTime) throws Exception {
        ...
        this.columns = new ArrayList<Field<?>>() { {
            this.add(DSL.field(DSL.name(Fields.shard.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.indexName.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.rid.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.tid.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.operation.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.role.name()), String.class));
    ...
    */
    public SelectHavingStep<Record> fetchLatency() {
        ...
        List<SelectField<?>> fields = new ArrayList<SelectField<?>>() { {
            ...
            this.add(DSL.field(DSL.name(Fields.st.name()), Long.class));
            this.add(DSL.field(DSL.name(Fields.et.name()), Long.class));
            this.add(DSL.field(Fields.et.name()).minus(DSL.field(Fields.st.name())).as(DSL.name(Fields.lat.name())));
        } };
    ...
    */
    ...
    public SelectHavingStep<Record> getCoalescedRequestsForTimeSpentInWindow() {
        ...
        fields.add(DSL.greatest(DSL.coalesce(DSL.max(DSL.field(Fields.st.name())),
                                        (this.windowStartTime)), this.windowStartTime)
                .as(DSL.name(Fields.st.name())));
        fields.add(DSL.least(DSL.coalesce(DSL.max(DSL.field(Fields.et.name())), endTime), endTime)
                .as(DSL.name(Fields.et.name())));
    ...
    public SelectHavingStep<Record> groupByRidOpSelect() {
        ArrayList<SelectField<?>> fields = new ArrayList<SelectField<?>>() { {
            ...
            this.add(DSL.field(DSL.name(Fields.operation.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.role.name()), String.class));
            this.add(DSL.max(DSL.field(Fields.st.name())).as(DSL.name(Fields.st.name())));
            this.add(DSL.max(DSL.field(Fields.et.name())).as(DSL.name(Fields.et.name())));
        } };
    ...
    public SelectHavingStep<Record> requestsPerThreadSelect() {
        ...
        List<SelectField<?>> fields = new ArrayList<SelectField<?>>() { {
            ...
            this.add(DSL.field(DSL.name(Fields.indexName.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.rid.name()), String.class));
            this.add(DSL.field(groupByRidOp.field(Fields.tid.name())));
            this.add(DSL.field(DSL.name(Fields.operation.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.role.name()), String.class));
            this.add(DSL.field(DSL.name(Fields.st.name()), Long.class));
            this.add(DSL.field(DSL.name(Fields.et.name()), Long.class));
            this.add(DSL.field(DSL.name(Fields.latest.name()), Long.class));
        } };
        SelectHavingStep<Record2<Long, String>> threadTable = create
                    .select(DSL.max(DSL.field(Fields.st.name(), Long.class)).as(Fields.latest.name()),
                            DSL.field(DSL.name(Fields.tid.name()), String.class).as(Fields.tid.name()))
                    .from(groupByRidOp)
                    .groupBy(DSL.field(Fields.tid.name()));

        return create.select(fields).from(groupByRidOp).join(threadTable)
            .on(threadTable.field(DSL.field(Fields.tid.name())).eq(groupByRidOp.field(Fields.tid.name())));
    }
    ...
    public SelectHavingStep<Record> fetchInflightSelect() {
        ...
        return create.select(fields).from(reqPerThread)
            .where(DSL.field(Fields.st.name()).isNotNull()
                    .and(DSL.field(Fields.st.name()).gt(this.windowStartTime)
                        .or(DSL.field(Fields.latest.name()).eq(DSL.field(Fields.st.name())))
                        )
    ...
    public SelectHavingStep<Record> fetchTotalTimeTable(SelectHavingStep<Record> timeSpentPerRequestSelect) {
        List<SelectField<?>> fields = new ArrayList<SelectField<?>>();
        fields.add(DSL.field(Fields.tid.name()));
        fields.add(DSL.sum(DSL.field(Fields.lat.name(), Double.class)).as(Fields.ttime.name()));
        return create.select(fields)
    ...
    public SelectHavingStep<Record> fetchThreadUtilizationRatioTable() {
        ...
        requestAndTotalThreadTimeFields.add(threadTable.field(Fields.ttime.name()));
        SelectHavingStep<Record> requestAndTotalThreadTimeSelect = create
            .select(requestAndTotalThreadTimeFields)
            .from(timeSpentPerReq)
            .join(threadTable)
            .on(timeSpentPerReq.field(Fields.tid.name(), String.class).eq(
                            threadTable.field(Fields.tid.name(), String.class)));
        ...
        tUtilFields.add(requestAndTotalThreadTimeSelect.field(Fields.lat.name()).mul(DSL.val(1.0d))
                .div(requestAndTotalThreadTimeSelect.field(Fields.ttime.name(), Double.class)).as(Fields.tUtil.name()));
