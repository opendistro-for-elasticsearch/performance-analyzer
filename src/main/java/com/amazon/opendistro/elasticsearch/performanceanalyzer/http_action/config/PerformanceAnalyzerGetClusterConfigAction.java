...
import static com.amazon.opendistro.elasticsearch.performanceanalyzer.config.setting.PerformanceAnalyzerConfigSettings.CLUSTER_CONFIG_PATH;
 ...
 *
 */
public class PerformanceAnalyzerGetClusterConfigAction extends BaseRestHandler {
    private static final Logger LOG = LogManager.getLogger(PerformanceAnalyzerGetClusterConfigAction.class);
    ...
    public PerformanceAnalyzerGetClusterConfigAction(final Settings settings, final RestController restController,
    ...
    private void registerHandlers(final RestController controller) {
        controller.registerHandler(RestRequest.Method.GET, CLUSTER_CONFIG_PATH, this);
    }
    ...
    public String getName() {
        return PerformanceAnalyzerGetClusterConfigAction.class.getSimpleName();
    }
