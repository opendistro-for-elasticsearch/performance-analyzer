...
@Ignore
public class ShardStatsCollectorTest extends CustomMetricsLocationTestBase {

    @Test
    public void testShardsStateMetrics() {
        MetricsConfiguration.CONFIG_MAP.put(ShardStatsCollector.class, MetricsConfiguration.cdefault);
        System.setProperty("performanceanalyzer.metrics.log.enabled", "False");
        long startTimeInMills = 1153721339;
        ShardStatsCollector shardsStateCollector = new ShardStatsCollector();
