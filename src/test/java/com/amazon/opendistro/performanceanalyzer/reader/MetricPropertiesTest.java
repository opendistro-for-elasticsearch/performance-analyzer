...
public class MetricPropertiesTest extends AbstractReaderTest {

    public MetricPropertiesTest() throws SQLException, ClassNotFoundException {
        super();
    }
    ...
    public void testHeap() throws Exception {
        ...
        write(output, false,
                ...
                createHeapMetrics(GCType.totYoungGC, 0, 0),
                createHeapMetrics(GCType.totFullGC, 0, 0),
                createHeapMetrics(GCType.Surivor, 69730304, 69730304, 69730304,
                        6343808),
                createHeapMetrics(GCType.PermGen, 144998400, 0, -1, 137707592),
                createHeapMetrics(GCType.OldGen, 32051232768L, 32051232768L,
                        32051232768L, 650876744),
                createHeapMetrics(GCType.Eden, 558432256, 558432256, 558432256,
                        367013104),
                createHeapMetrics(GCType.NonHeap, 259436544, 2555904, -1,
                        249276784),
        ...
        fields[0] = DSL.field(HeapValue.collectionCount.toString(),
                Double.class);
        fields[1] =
                DSL.field(HeapValue.collectionTime.toString(), Double.class);
        fields[2] = DSL.field(HeapValue.committed.toString(),
                Double.class);
        fields[3] = DSL.field(HeapValue.init.toString(),
                Double.class);
        fields[4] = DSL.field(HeapValue.max.toString(),
                Double.class);
        fields[5] = DSL.field(HeapValue.used.toString(),
                Double.class);

        Result<Record> resRecord = heapSnap.fetchMetric(
                getDimensionEqCondition(
                        HeapDimension.type,
                        GCType.totYoungGC.toString()),
                fields);
    ...
    public void testShardStat() throws Exception {
        ...
        fields[0] = DSL.field(ShardStatsValue.segmentCount.toString(),
                Double.class);
        fields[1] = DSL.field(ShardStatsValue.segmentsMemory.toString(),
                Double.class);
        fields[2] = DSL.field(ShardStatsValue.termVectorsMemory.toString(),
                Double.class);
        fields[3] = DSL.field(ShardStatsValue.fieldDataEvictions.toString(),
                Double.class);
        fields[4] = DSL.field(ShardStatsValue.docValuesMemory.toString(),
                Double.class);
        fields[5] = DSL.field(ShardStatsValue.mergeCount.toString(),
                Double.class);

        Result<Record> resRecord = shardStatSnap.fetchMetric(
                getDimensionEqCondition(
                        ShardStatsDerivedDimension.indexName,
                        moviesIndex),
                fields);
        ...
        Result<Record> resRecord2 = shardStatSnap.fetchMetric(
                getDimensionEqCondition(ShardStatsDerivedDimension.indexName,
                        moviesIndex)
                                .and(getDimensionEqCondition(
                                        ShardStatsDerivedDimension.shardID,
                                        "0")),
                fields);
